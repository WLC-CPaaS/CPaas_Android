...
public class ServiceVOIPAccountEditData {
  ...
  public boolean equals(Object o) {
    ...
    return (this.callerId == null ? serviceVOIPAccountEditData.callerId == null : this.callerId.equals(serviceVOIPAccountEditData.callerId)) &&
        (this.doNotDisturb == null ? serviceVOIPAccountEditData.doNotDisturb == null : this.doNotDisturb.equals(serviceVOIPAccountEditData.doNotDisturb)) &&
        (this.enabled == null ? serviceVOIPAccountEditData.enabled == null : this.enabled.equals(serviceVOIPAccountEditData.enabled)) &&
        (this.musicOnHold == null ? serviceVOIPAccountEditData.musicOnHold == null : this.musicOnHold.equals(serviceVOIPAccountEditData.musicOnHold)) &&
        (this.name == null ? serviceVOIPAccountEditData.name == null : this.name.equals(serviceVOIPAccountEditData.name)) &&
        (this.timezone == null ? serviceVOIPAccountEditData.timezone == null : this.timezone.equals(serviceVOIPAccountEditData.timezone));
  }
