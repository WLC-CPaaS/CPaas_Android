...
public class ServiceWebhookAdd {
  ...
  public boolean equals(Object o) {
    ...
    return (this.callbackMethod == null ? serviceWebhookAdd.callbackMethod == null : this.callbackMethod.equals(serviceWebhookAdd.callbackMethod)) &&
        (this.callbackUrl == null ? serviceWebhookAdd.callbackUrl == null : this.callbackUrl.equals(serviceWebhookAdd.callbackUrl)) &&
        (this.data == null ? serviceWebhookAdd.data == null : this.data.equals(serviceWebhookAdd.data)) &&
        (this.title == null ? serviceWebhookAdd.title == null : this.title.equals(serviceWebhookAdd.title)) &&
        (this.webhookType == null ? serviceWebhookAdd.webhookType == null : this.webhookType.equals(serviceWebhookAdd.webhookType));
  }
