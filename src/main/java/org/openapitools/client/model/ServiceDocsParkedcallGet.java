...
public class ServiceDocsParkedcallGet {
  ...
  public boolean equals(Object o) {
    ...
    return (this.data == null ? serviceDocsParkedcallGet.data == null : this.data.equals(serviceDocsParkedcallGet.data)) &&
        (this.nextStartKey == null ? serviceDocsParkedcallGet.nextStartKey == null : this.nextStartKey.equals(serviceDocsParkedcallGet.nextStartKey)) &&
        (this.pageSize == null ? serviceDocsParkedcallGet.pageSize == null : this.pageSize.equals(serviceDocsParkedcallGet.pageSize)) &&
        (this.requestId == null ? serviceDocsParkedcallGet.requestId == null : this.requestId.equals(serviceDocsParkedcallGet.requestId)) &&
        (this.startKey == null ? serviceDocsParkedcallGet.startKey == null : this.startKey.equals(serviceDocsParkedcallGet.startKey)) &&
        (this.statusCode == null ? serviceDocsParkedcallGet.statusCode == null : this.statusCode.equals(serviceDocsParkedcallGet.statusCode));
  }
